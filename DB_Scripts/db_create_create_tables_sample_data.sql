...
-- Dumping database structure for coronatravels
DROP DATABASE IF EXISTS `coronatravels`;
CREATE DATABASE IF NOT EXISTS `coronatravels` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `coronatravels`;
...
-- Dumping data for table coronatravels.hotels: ~0 rows (approximately)
...
-- Dumping data for table coronatravels.images: ~0 rows (approximately)
...
-- Dumping data for table coronatravels.trips: ~0 rows (approximately)
...
-- Dumping data for table coronatravels.users: ~0 rows (approximately)
